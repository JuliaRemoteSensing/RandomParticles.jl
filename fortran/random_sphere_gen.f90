...
contains
   ...
   subroutine random_cluster_of_spheres(numberspheres,sphereposition,sphereradius,iunit,istatus, &
      ntsteps)
      implicit none
      logical :: fitok,allin,trystage1,skipdif,pprog,printsim
      ...
      ![JuliaRemoteSensing]
      ! In this modified version, sphereradius is input
      spherevol=0.d0
      do i=1,numberspheres
         spherevol=spherevol+4.d0*pi*sphereradius(i)**3/3.d0
      enddo
      ...
      write(6, *) "Target Vol = ", targetvol, "Target FV = ", targetfv
